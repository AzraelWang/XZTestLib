#
#  Be sure to run `pod spec lint Ship.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
shipshipshipshipshipshipshipshipshipshipshipshipshipshipshipshipshipshipshipship
                   DESC

  s.homepage     = "https://github.com/AzraelWang"
